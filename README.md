**D&D Spellbook Applicatie (Backend)**

**Link naar de GitHub-repository:** https://github.com/Ralph-Beentjes/dnd-spellbook-eindopdracht-novi
...
![](https://i.postimg.cc/K8q4LfVX/projectstructuur-backend.png)

Technieken en frameworks:

- Java (versie 25)
- Spring Boot (versie 4.0)
- Maven
- Spring Web
- Spring Data JPA
- Spring OAuth 2.0
...
- (Optioneel) Als de database problemen geeft bij het opstarten na de eerste keer, verander 'spring.sql.init.mode=always' in application.properties naar '=never'
